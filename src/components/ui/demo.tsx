...
const testimonials: Testimonial[] = [
    ...
    id: 1,
    quote:
      "A experiência com a Reffinatto foi impecável. O relógio superou minhas expectativas em cada detalhe.",
    name: "Eduardo Martins",
    username: "@edumartins",
    avatar:
      "https://images.unsplash.com/photo-1603415526960-f7e0328b9f67?q=80&w=3000&auto=format&fit=crop",
  },
  {
    id: 2,
    quote:
      "Design sofisticado e acabamento perfeito. É mais que um acessório — é uma peça de arte no pulso.",
    name: "Ricardo Silva",
    username: "@ricardosilva",
    avatar:
      "https://images.unsplash.com/photo-1590080875831-b2d63b9421fa?q=80&w=3000&auto=format&fit=crop",
  },
  {
    id: 3,
    quote:
      "Atendimento excelente e entrega pontual. A Reffinatto realmente redefine o conceito de elegância.",
    name: "Marcelo Souza",
    username: "@marcelosouza",
    avatar:
      "https://images.unsplash.com/photo-1603415526813-7b96c0e3b8a6?q=80&w=3000&auto=format&fit=crop",
  },
  {
    id: 4,
    quote:
      "Um relógio que transmite status e estilo. Desde o design até a embalagem, tudo foi de alto padrão.",
    name: "Henrique Castro",
    username: "@henriquecastro",
    avatar:
      "https://images.unsplash.com/photo-1614289062222-efb8b9b1eebf?q=80&w=3000&auto=format&fit=crop",
  },
  {
    id: 5,
    quote:
      "Senti que estava comprando algo exclusivo. A Reffinatto entende o verdadeiro significado do luxo.",
    name: "Lucas Fernandes",
    username: "@lucasfernandes",
    avatar:
      "https://images.unsplash.com/photo-1623018031850-3b4a71d9a97c?q=80&w=3000&auto=format&fit=crop",
  },
];
        ...
        <div className="px-4 py-8 sm:py-16 bg-[#0B0C10] dark:from-gray-900 dark:to-gray-800 overflow-hidden">
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <h3 className=" font-play text-2xl sm:text-3xl md:text-6xl font-bold text-white mt-3 sm:mt-10 px-4">
                        Experiências  <span className="text-[#C8A24A]">que redefinem o luxo</span>
                    </h3>
